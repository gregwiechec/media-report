...
namespace AlloyTemplates.Models.Pages
{
    ...
    public class AllPropertiesTestPage : PageData
    {
        ...
        [Display(Name = "Integer List", Description = Description, GroupName = SystemTabNames.Content, Order = 220)]
        public virtual IEnumerable<int> IntegerList1 { get; set; }

        [Display(Name = "Integer List [Readonly]", Description = Description, GroupName = SystemTabNames.Content, Order = 230)]
        [ReadOnly(true)]
        ...
        [Display(Name = "List property", Description = Description, GroupName = SystemTabNames.Content, Order = 290)]
        [EditorDescriptor(EditorDescriptorType = typeof(CollectionEditorDescriptor<Person>))]
        public virtual IList<Person> Persons { get; set; }

        [Display(Name = "List property [Readonly]", Description = Description, GroupName = SystemTabNames.Content, Order = 300)]
        [EditorDescriptor(EditorDescriptorType = typeof(CollectionEditorDescriptor<Person>))]
        [ReadOnly(true)]
